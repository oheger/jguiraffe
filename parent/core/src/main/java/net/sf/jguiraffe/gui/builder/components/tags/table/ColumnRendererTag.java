 ...
 * rendering the column this tag belongs to. No other specific attributes are
 * supported.
 * </p>
 * <p>
 ...
 *
 * @author Oliver Heger
 * @version $Id: ColumnRendererTag.java 205 2012-01-29 18:29:57Z oheger $
 * @see TableTag
 * @see TableColumnTag
 */
public class ColumnRendererTag extends ColumnComponentTag
{
     ...
     * implementation will return the render form.
     *
    ...
    {
        return tabTag.getRowRenderForm();
    }

    /**
     * Initializes the passed in column tag with the results produced by this
     * tag. This implementation sets the renderer component and the set with the
     * names of the components used by the renderer form for this column.
     *
    ...
    {
        colTag.initRendererComponent(bodyComponent);
        colTag.initRenderFields(componentNames);
    }
}
